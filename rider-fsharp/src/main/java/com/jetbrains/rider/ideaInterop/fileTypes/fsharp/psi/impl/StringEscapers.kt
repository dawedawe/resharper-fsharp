...
class RegularStringEscaper(host: FSharpStringLiteralExpression) :
    StringLiteralEscaper<FSharpStringLiteralExpression>(host)

class VerbatimStringEscaper(host: FSharpStringLiteralExpression) :
    StringLiteralEscaper<FSharpStringLiteralExpression>(host)

class TripleQuotedStringEscaper(host: FSharpStringLiteralExpression) :
    StringLiteralEscaper<FSharpStringLiteralExpression>(host)
