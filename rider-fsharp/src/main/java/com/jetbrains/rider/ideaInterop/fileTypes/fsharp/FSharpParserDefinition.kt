...
open class FSharpParserDefinitionBase(fileElementType: RiderFileElementType, languageFileType: LanguageFileType) :
  RiderParserDefinitionBase(fileElementType, languageFileType) {
...
class FSharpParserDefinition : FSharpParserDefinitionBase(FSharpElementTypes.FILE, FSharpFileType) {
  override fun createFile(viewProvider: FileViewProvider) = FSharpFileImpl(viewProvider)
}

class FSharpScriptParserDefinition : FSharpParserDefinitionBase(FSharpElementTypes.SCRIPT_FILE, FSharpScriptFileType) {
